...
const en: LocaleType = {
  ...
  Store: {
    ...
    Prompt: {
      History: (content: string) => "We chatted before:\n" + content,
      Topic: "Summarize this conversation in concise language.",
      Summarize: "Summarize the chat content, the concise the better",
    },
  },
  Copy: {
